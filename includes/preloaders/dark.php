<optgroup label="Dark background">
	...
	<option value="apple.gif" class="sws-preloader-black" <?php sws_set_selected( 'apple.gif' ); ?>>Apple</option>
	<option value="green-sphere-cutting.gif" class="sws-preloader-black" <?php sws_set_selected( 'green-sphere-cutting.gif' ); ?>>Green sphere cutting</option>
	<option value="infinity-blinking.gif" class="sws-preloader-black" <?php sws_set_selected( 'infinity-blinking.gif' ); ?>>Infinity blinking</option>
	<option value="star.gif" class="sws-preloader-black" <?php sws_set_selected( 'star.gif' ); ?>>Star</option>
	<option value="stone-circle.gif" class="sws-preloader-black" <?php sws_set_selected( 'stone-circle.gif' ); ?>>Stone circle</option>
