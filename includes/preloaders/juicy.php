<optgroup label="Juicy background">
	...
	<option value="running-cat.gif" class="sws-preloader-blue" <?php sws_set_selected( 'running-cat.gif' ); ?>>Running cat</option>
	<option value="cat-with-headphones.gif" class="sws-preloader-purple" <?php sws_set_selected( 'cat-with-headphones.gif' ); ?>>Cat with headphones</option>
	<option value="beer.gif" class="sws-preloader-soap-green" <?php sws_set_selected( 'beer.gif' ); ?>>Beer</option>
	<option value="click-to-load-button.gif" class="sws-preloader-pale-green" <?php sws_set_selected( 'click-to-load-button.gif' ); ?>>Click to load button</option>
	<option value="compass-loading.gif" class="sws-preloader-blue" <?php sws_set_selected( 'compass-loading.gif' ); ?>>Compass loading</option>
	<option value="fox-fun-walk.gif" class="sws-preloader-pale-purple" <?php sws_set_selected( 'fox-fun-walk.gif' ); ?>>Fox fun walk</option>
	<option value="gnu-loader.gif" class="sws-preloader-blue" <?php sws_set_selected( 'gnu-loader.gif' ); ?>>Gnu loader</option>
	<option value="kitten-enjoing.gif" class="sws-preloader-sky-blue" <?php sws_set_selected( 'kitten-enjoing.gif' ); ?>>Kitten enjoing</option>
	<option value="map-marker-hiding.gif" class="sws-preloader-pale-green" <?php sws_set_selected( 'map-marker-hiding.gif' ); ?>>Map marke hiding</option>
	<option value="white-fractal-ring.gif" class="sws-preloader-salad-green" <?php sws_set_selected( 'white-fractal-ring.gif' ); ?>>White fractal ring</option>
	<option value="white-thick-circle.gif" class="sws-preloader-sky-blue" <?php sws_set_selected( 'white-thick-circle.gif' ); ?>>White thick circle</option>
